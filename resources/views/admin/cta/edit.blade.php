    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cta.update", [$ctum->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tagline') ? 'is-invalid' : '' }}" type="text" name="tagline" id="tagline" value="{{ old('tagline', $ctum->tagline) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content">{{ old('content', $ctum->content) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('btn_text') ? 'is-invalid' : '' }}" type="text" name="btn_text" id="btn_text" value="{{ old('btn_text', $ctum->btn_text) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('btn_link') ? 'is-invalid' : '' }}" type="text" name="btn_link" id="btn_link" value="{{ old('btn_link', $ctum->btn_link) }}">
