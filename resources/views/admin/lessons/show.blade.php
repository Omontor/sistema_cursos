...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#lesson_lesson_questions" role="tab" data-toggle="tab">
                {{ trans('cruds.lessonQuestion.title') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#lesson_progress" role="tab" data-toggle="tab">
                {{ trans('cruds.progress.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="lesson_lesson_questions">
            @includeIf('admin.lessons.relationships.lessonLessonQuestions', ['lessonQuestions' => $lesson->lessonLessonQuestions])
        </div>
        <div class="tab-pane" role="tabpanel" id="lesson_progress">
            @includeIf('admin.lessons.relationships.lessonProgress', ['progress' => $lesson->lessonProgress])
        </div>
    </div>
</div>
