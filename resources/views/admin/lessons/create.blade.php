    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.lessons.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('short_text') ? 'is-invalid' : '' }}" name="short_text" id="short_text">{{ old('short_text') }}</textarea>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('videoid') ? 'is-invalid' : '' }}" type="text" name="videoid" id="videoid" value="{{ old('videoid', '') }}">
