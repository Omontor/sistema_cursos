    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-coursePurchasedTransactions">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($transactions as $key => $transaction)
                            <tr data-entry-id="{{ $transaction->id }}">
                                ...
                                <td>
                                    @foreach($transaction->course_purchaseds as $key => $item)
                                ...
                                <td>
                                    <span style="display:none">{{ $transaction->coupon_use ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-coursePurchasedTransactions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
