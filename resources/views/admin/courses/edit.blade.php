        ...
        <form method="POST" action="{{ route("admin.courses.update", [$course->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <textarea class="form-control  {{ $errors->has('excerpt') ? 'is-invalid' : '' }}" name="excerpt" id="excerpt">{!! old('excerpt', $course->excerpt) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" required>{{ old('description', $course->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" type="number" name="discount" id="discount" value="{{ old('discount', $course->discount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('requirements') ? 'is-invalid' : '' }}" name="requirements[]" id="requirements" multiple>
                    @foreach($requirements as $id => $requirements)
                        <option value="{{ $id }}" {{ (in_array($id, old('requirements', [])) || $course->requirements->contains($id)) ? 'selected' : '' }}>{{ $requirements }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('knowledge') ? 'is-invalid' : '' }}" name="knowledge" id="knowledge">{!! old('knowledge', $course->knowledge) !!}</textarea>
