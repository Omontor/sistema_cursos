...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sendinblues.update", [$sendinblue->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="host">{{ trans('cruds.sendinblue.fields.host') }}</label>
                <input class="form-control {{ $errors->has('host') ? 'is-invalid' : '' }}" type="text" name="host" id="host" value="{{ old('host', $sendinblue->host) }}" required>
                @if($errors->has('host'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user') ? 'is-invalid' : '' }}" type="text" name="user" id="user" value="{{ old('user', $sendinblue->user) }}" required>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('api') ? 'is-invalid' : '' }}" type="text" name="api" id="api" value="{{ old('api', $sendinblue->api) }}">
                @if($errors->has('api'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="text" name="password" id="password" value="{{ old('password', $sendinblue->password) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('security') ? 'is-invalid' : '' }}" type="text" name="security" id="security" value="{{ old('security', $sendinblue->security) }}" required>
