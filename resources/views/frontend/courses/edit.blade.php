                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.courses.update", [$course->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="requirements[]" id="requirements" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="video" id="video" value="{{ old('video', $course->video) }}">
                            @if($errors->has('video'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('video') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="knowledge" id="knowledge">{!! old('knowledge', $course->knowledge) !!}</textarea>
