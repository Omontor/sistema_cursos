        ...
        <div class="col-md-12">
            @can('online_class_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.online-classes.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $onlineClass->id }}">
                                        ...
                                        <td>
                                            @can('online_class_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.online-classes.show', $onlineClass->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('online_class_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.online-classes.edit', $onlineClass->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('online_class_delete')
                                                <form action="{{ route('frontend.online-classes.destroy', $onlineClass->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('online_class_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.online-classes.massDestroy') }}",
