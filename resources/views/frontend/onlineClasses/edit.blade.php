    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.online-classes.update", [$onlineClass->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_reunion" id="id_reunion" value="{{ old('id_reunion', $onlineClass->id_reunion) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $onlineClass->title) }}" required>
                            @if($errors->has('title'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('title') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="excerpt" id="excerpt" required>{{ old('excerpt', $onlineClass->excerpt) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="content" id="content">{!! old('content', $onlineClass->content) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="duration" id="duration" value="{{ old('duration', $onlineClass->duration) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password" id="password" value="{{ old('password', $onlineClass->password) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_student" id="max_student" value="{{ old('max_student', $onlineClass->max_student) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="start" id="start" value="{{ old('start', $onlineClass->start) }}" required>
                            @if($errors->has('start'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('start') }}
                                </div>
