                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('forum_category_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.forum-categories.index') }}">
                                    ...
                                    @can('forum_like_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.forum-likes.index') }}">
                                    ...
                                    @can('forum_complaint_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.forum-complaints.index') }}">
                                            {{ trans('cruds.forumComplaint.title') }}
                                        </a>
                                    @endcan
                                    @can('complaint_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.complaint-types.index') }}">
                                    ...
                                    @can('referral_source_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.referral-sources.index') }}">
