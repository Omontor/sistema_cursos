...
class IndexTestimonialController extends Controller
{
    public function index()
    {
        ...
        return view('admin.indexTestimonials.index', compact('indexTestimonials'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.indexTestimonials.create', compact('users'));
    }
    ...
    public function store(StoreIndexTestimonialRequest $request)
    {
        ...
        return redirect()->route('admin.index-testimonials.index');
    }
    ...
    public function edit(IndexTestimonial $indexTestimonial)
    {
        ...
        return view('admin.indexTestimonials.edit', compact('users', 'indexTestimonial'));
    }
    ...
    public function show(IndexTestimonial $indexTestimonial)
    {
        ...
        return view('admin.indexTestimonials.show', compact('indexTestimonial'));
    }
