...
class OnlineClassController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.onlineClasses.index', compact('onlineClasses', 'courses', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.onlineClasses.create', compact('courses'));
    }
    ...
    public function edit(OnlineClass $onlineClass)
    {
        ...
        return view('admin.onlineClasses.edit', compact('courses', 'onlineClass'));
    }
    ...
    public function show(OnlineClass $onlineClass)
    {
        ...
        return view('admin.onlineClasses.show', compact('onlineClass'));
    }
