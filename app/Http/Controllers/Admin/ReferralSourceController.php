...
class ReferralSourceController extends Controller
{
    public function index()
    {
        ...
        return view('admin.referralSources.index', compact('referralSources'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.referralSources.create');
    }
    ...
    public function store(StoreReferralSourceRequest $request)
    {
        ...
        return redirect()->route('admin.referral-sources.index');
    }
    ...
    public function edit(ReferralSource $referralSource)
    {
        ...
        return view('admin.referralSources.edit', compact('referralSource'));
    }
    ...
    public function show(ReferralSource $referralSource)
    {
        ...
        return view('admin.referralSources.show', compact('referralSource'));
    }
