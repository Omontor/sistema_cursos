...
class ForumCommentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.forumComments.index', compact('forumComments', 'forum_threads', 'users'));
    }
    ...
    public function edit(ForumComment $forumComment)
    {
        ...
        return view('admin.forumComments.edit', compact('threads', 'users', 'forumComment'));
    }
