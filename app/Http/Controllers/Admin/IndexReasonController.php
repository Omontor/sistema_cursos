...
class IndexReasonController extends Controller
{
    public function index()
    {
        ...
        return view('admin.indexReasons.index', compact('indexReasons'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.indexReasons.create');
    }
    ...
    public function store(StoreIndexReasonRequest $request)
    {
        ...
        return redirect()->route('admin.index-reasons.index');
    }
    ...
    public function edit(IndexReason $indexReason)
    {
        ...
        return view('admin.indexReasons.edit', compact('indexReason'));
    }
    ...
    public function show(IndexReason $indexReason)
    {
        ...
        return view('admin.indexReasons.show', compact('indexReason'));
    }
