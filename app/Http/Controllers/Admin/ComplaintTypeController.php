...
class ComplaintTypeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.complaintTypes.index', compact('complaintTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.complaintTypes.create');
    }
    ...
    public function edit(ComplaintType $complaintType)
    {
        ...
        return view('admin.complaintTypes.edit', compact('complaintType'));
    }
    ...
    public function show(ComplaintType $complaintType)
    {
        ...
        return view('admin.complaintTypes.show', compact('complaintType'));
    }
