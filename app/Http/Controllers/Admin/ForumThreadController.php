...
class ForumThreadController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.forumThreads.index', compact('forumThreads', 'users', 'forum_categories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.forumThreads.create', compact('users', 'categories'));
    }
    ...
    public function edit(ForumThread $forumThread)
    {
        ...
        return view('admin.forumThreads.edit', compact('users', 'categories', 'forumThread'));
    }
