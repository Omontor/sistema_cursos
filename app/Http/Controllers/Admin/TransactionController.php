...
class TransactionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.transactions.create', compact('course_purchaseds', 'users', 'payment_types'));
    }
    ...
    public function edit(Transaction $transaction)
    {
        ...
        return view('admin.transactions.edit', compact('course_purchaseds', 'users', 'payment_types', 'transaction'));
    }
