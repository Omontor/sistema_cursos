...
class BulletController extends Controller
{
    public function index()
    {
        ...
        return view('admin.bullets.index', compact('bullets'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.bullets.create');
    }
    ...
    public function store(StoreBulletRequest $request)
    {
        ...
        return redirect()->route('admin.bullets.index');
    }
    ...
    public function edit(Bullet $bullet)
    {
        ...
        return view('admin.bullets.edit', compact('bullet'));
    }
    ...
    public function show(Bullet $bullet)
    {
        ...
        return view('admin.bullets.show', compact('bullet'));
    }
