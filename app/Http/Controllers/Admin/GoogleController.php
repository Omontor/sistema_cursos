...
class GoogleController extends Controller
{
    public function index()
    {
        ...
        return view('admin.googles.index', compact('googles'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.googles.create');
    }
    ...
    public function store(StoreGoogleRequest $request)
    {
        ...
        return redirect()->route('admin.googles.index');
    }
    ...
    public function edit(Google $google)
    {
        ...
        return view('admin.googles.edit', compact('google'));
    }
    ...
    public function show(Google $google)
    {
        ...
        return view('admin.googles.show', compact('google'));
    }
