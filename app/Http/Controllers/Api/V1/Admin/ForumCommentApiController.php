...
class ForumCommentApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new ForumCommentResource(ForumComment::with(['thread', 'user'])->get());
    }
    ...
    public function show(ForumComment $forumComment)
    {
        ...
        return new ForumCommentResource($forumComment->load(['thread', 'user']));
    }
