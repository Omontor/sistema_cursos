...
class CoursesApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new CourseResource(Course::with(['teacher', 'students', 'requirements', 'created_by'])->get());
    }
    ...
    public function show(Course $course)
    {
        ...
        return new CourseResource($course->load(['teacher', 'students', 'requirements', 'created_by']));
    }
