...
class RequirmentController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.requirments.index', compact('requirments'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.requirments.create');
    }
    ...
    public function store(StoreRequirmentRequest $request)
    {
        ...
        return redirect()->route('frontend.requirments.index');
    }
    ...
    public function edit(Requirment $requirment)
    {
        ...
        return view('frontend.requirments.edit', compact('requirment'));
    }
    ...
    public function show(Requirment $requirment)
    {
        ...
        return view('frontend.requirments.show', compact('requirment'));
    }
