...
class CoursesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.courses.index', compact('courses', 'users', 'requirments'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.courses.create', compact('teachers', 'students', 'requirements'));
    }
    ...
    public function edit(Course $course)
    {
        ...
        return view('frontend.courses.edit', compact('teachers', 'students', 'requirements', 'course'));
    }
