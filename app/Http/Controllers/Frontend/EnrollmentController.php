...
class EnrollmentController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.enrollments.index', compact('enrollments'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.enrollments.create', compact('users', 'courses'));
    }
    ...
    public function edit(Enrollment $enrollment)
    {
        ...
        return view('frontend.enrollments.edit', compact('users', 'courses', 'enrollment'));
    }
