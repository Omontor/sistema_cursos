...
class CtaController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.cta.index', compact('cta'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.cta.create');
    }
    ...
    public function store(StoreCtumRequest $request)
    {
        ...
        return redirect()->route('frontend.cta.index');
    }
    ...
    public function edit(Ctum $ctum)
    {
        ...
        return view('frontend.cta.edit', compact('ctum'));
    }
    ...
    public function show(Ctum $ctum)
    {
        ...
        return view('frontend.cta.show', compact('ctum'));
    }
