...
class FeaturedCourseController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.featuredCourses.index', compact('featuredCourses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.featuredCourses.create', compact('courses'));
    }
    ...
    public function store(StoreFeaturedCourseRequest $request)
    {
        ...
        return redirect()->route('frontend.featured-courses.index');
    }
    ...
    public function edit(FeaturedCourse $featuredCourse)
    {
        ...
        return view('frontend.featuredCourses.edit', compact('courses', 'featuredCourse'));
    }
    ...
    public function show(FeaturedCourse $featuredCourse)
    {
        ...
        return view('frontend.featuredCourses.show', compact('featuredCourse'));
    }
