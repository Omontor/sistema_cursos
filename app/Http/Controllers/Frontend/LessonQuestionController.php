...
class LessonQuestionController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.lessonQuestions.index', compact('lessonQuestions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.lessonQuestions.create', compact('users', 'lessons'));
    }
    ...
    public function store(StoreLessonQuestionRequest $request)
    {
        ...
        return redirect()->route('frontend.lesson-questions.index');
    }
    ...
    public function edit(LessonQuestion $lessonQuestion)
    {
        ...
        return view('frontend.lessonQuestions.edit', compact('users', 'lessons', 'lessonQuestion'));
    }
    ...
    public function show(LessonQuestion $lessonQuestion)
    {
        ...
        return view('frontend.lessonQuestions.show', compact('lessonQuestion'));
    }
