...
class SendinblueController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.sendinblues.index', compact('sendinblues'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.sendinblues.create');
    }
    ...
    public function store(StoreSendinblueRequest $request)
    {
        ...
        return redirect()->route('frontend.sendinblues.index');
    }
    ...
    public function edit(Sendinblue $sendinblue)
    {
        ...
        return view('frontend.sendinblues.edit', compact('sendinblue'));
    }
    ...
    public function show(Sendinblue $sendinblue)
    {
        ...
        return view('frontend.sendinblues.show', compact('sendinblue'));
    }
