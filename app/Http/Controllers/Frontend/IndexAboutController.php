...
class IndexAboutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.indexAbouts.index', compact('indexAbouts'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.indexAbouts.create');
    }
    ...
    public function store(StoreIndexAboutRequest $request)
    {
        ...
        return redirect()->route('frontend.index-abouts.index');
    }
    ...
    public function edit(IndexAbout $indexAbout)
    {
        ...
        return view('frontend.indexAbouts.edit', compact('indexAbout'));
    }
    ...
    public function show(IndexAbout $indexAbout)
    {
        ...
        return view('frontend.indexAbouts.show', compact('indexAbout'));
    }
