...
class ReviewController extends Controller
{
    public function index()
    {
        ...
        $reviews = Review::with(['user', 'course', 'created_by'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.reviews.create', compact('users', 'courses'));
    }
    ...
    public function edit(Review $review)
    {
        ...
        $review->load('user', 'course', 'created_by');

        return view('frontend.reviews.edit', compact('users', 'courses', 'review'));
    }
