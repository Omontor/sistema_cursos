...
class ForumComplaintController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.forumComplaints.index', compact('forumComplaints'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.forumComplaints.create', compact('users', 'types'));
    }
    ...
    public function store(StoreForumComplaintRequest $request)
    {
        ...
        return redirect()->route('frontend.forum-complaints.index');
    }
    ...
    public function edit(ForumComplaint $forumComplaint)
    {
        ...
        return view('frontend.forumComplaints.edit', compact('users', 'types', 'forumComplaint'));
    }
    ...
    public function show(ForumComplaint $forumComplaint)
    {
        ...
        return view('frontend.forumComplaints.show', compact('forumComplaint'));
    }
