...
class SocialNetworkController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.socialNetworks.index', compact('socialNetworks'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.socialNetworks.create');
    }
    ...
    public function store(StoreSocialNetworkRequest $request)
    {
        ...
        return redirect()->route('frontend.social-networks.index');
    }
    ...
    public function edit(SocialNetwork $socialNetwork)
    {
        ...
        return view('frontend.socialNetworks.edit', compact('socialNetwork'));
    }
    ...
    public function show(SocialNetwork $socialNetwork)
    {
        ...
        return view('frontend.socialNetworks.show', compact('socialNetwork'));
    }
