...
class ProgressController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.progress.index', compact('progress'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.progress.create', compact('users', 'lessons'));
    }
    ...
    public function store(StoreProgressRequest $request)
    {
        ...
        return redirect()->route('frontend.progress.index');
    }
    ...
    public function edit(Progress $progress)
    {
        ...
        return view('frontend.progress.edit', compact('users', 'lessons', 'progress'));
    }
    ...
    public function show(Progress $progress)
    {
        ...
        return view('frontend.progress.show', compact('progress'));
    }
